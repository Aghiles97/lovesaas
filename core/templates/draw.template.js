  ...
  const renderDrawApp = (p1 = "", p2 = "", customPrompts = {}) => `
              <div class="draw-app">
                ...
                <div id="stageLobby" class="draw-stage active">
                  <div class="draw-lobby-card photobooth-style lobby-split-layout">
                    ...
                    <div class="draw-lobby-split-row">
                      ...
                      <div class="draw-lobby-col-actions">
                        <div class="ldr-welcome-choices" id="lobbyInitialView">
                          ...
                          <!-- Inline Join Form: Reveals when clicking "Join a room" -->
                          ...
                          <div style="margin-top: 6px;">
                            <button type="button" class="ldr-text-back-btn" id="btnBackToWebsite">← Back to Website</button>
                          </div>
                        </div>
